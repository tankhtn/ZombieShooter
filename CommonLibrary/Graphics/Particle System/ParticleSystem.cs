...
namespace CommonLibrary.Graphics
{
    ...
    /// </summary>
    public abstract class ParticleSystem : IVisibleGameEntity
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        protected ParticleSystem(GraphicsDevice device, ContentManager content, Camera camera)
            : this(device, content, camera, null)
        {
        }
        ...
        protected void LoadContent()
        {
            ...
            vertexBuffer = new DynamicVertexBuffer(_device, ParticleVertex.VertexDeclaration,
            ...
            indexBuffer = new IndexBuffer(_device, typeof(ushort), indices.Length, BufferUsage.WriteOnly);
        ...
        {
            Effect effect = content.Load<Effect>(@"level 1\effects\ParticleEffect");
        ...
        {
            SetCamera(_camera.View, _camera.Projection);
            ...
            if (firstActiveParticle != firstFreeParticle)
            {
                ...
                effectViewportScaleParameter.SetValue(new Vector2(0.5f / _device.Viewport.AspectRatio, -0.5f));
